...
### Challenges (Optional)
In our preliminary analysis, the challenges we faced were mapping the column names from their keys to their definitions. 
...
### Contributions
- Nicholas De La Cruz: Data cleaning, classification, KFold, linear regression
- Kareem Ibrahim: Data cleaning, improving the model, cross-validation
